        ...
        <section id="sobre-fdv" className="py-20 px-4 bg-gradient-to-b from-white to-gray-50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { nombre: 'Pastora Tavita Muñoz Orellano', rol: 'Pastora Principal | Fundadora de Casa FDV', descripcion: 'Fundadora, líder, consejera familiar y madre espiritual de CASA FDV, tomada de la mano del espíritu santo realizó más de 20 años de ministerio dedicados a servir, formar y transformar vidas con el poder de Dios. Su llamado comenzó predicando en calles, parques y losas deportivas, alcanzando a niños y jóvenes con un mensaje real de Jesús. Es de destacar su ardua lucha contra los demonios en la delincuencia y drogadicción que radican en las zonas más hostiles del país. Fundadora del ministerio Revelación Celestial, llevó el evangelio a distintas ciudades a través del arte, formando generaciones con propósito. Posee formación pastoral especializada en familia, hoy lidera CASA FDV: una iglesia y casa de refugio que impacta a niños, jóvenes y familias, extendiendo una visión de restauración y transformación en la cultura familiar. Y a todo esto se le entrega por excelencia al espíritu Santo, quién hizo y seguirá haciendo, a través de ella.' },
                { nombre: 'Pastora Abigail Muñoz Orellano', rol: 'Pastora de Casa | Directora de Alabanza y Adoración (KIDS FDV)', descripcion: 'Ha servido a Dios desde muy joven, destacándose por su corazón de adoradora y su sensibilidad espiritual. Dirige el ministerio de Alabanza y Adoración (KIDS-FDV), guiando a la congregación a encuentros genuinos con Dios a través de la música. Además, es pastora de mayordomía, directora de discipulado, líder de Women Héroes y gestora del emprendimiento económico y social de las señoritas, formando vidas con identidad, orden y propósito. Su liderazgo refleja pasión, entrega y un compromiso constante con el crecimiento espiritual de cada persona.' },
                { nombre: 'Pastora Débora Muñoz Orellano', rol: 'Pastora de Casa | Administradora de la Iglesia', descripcion: 'Ha servido a Dios desde muy joven, desarrollándose en diversas áreas del Ministerio con compromiso y excelencia. Actualmente es Administradora de la Iglesia y lidera áreas clave como el Equipo de Control, Dj’s y Logística, Orden, Servicio en el Altar, Producciones y Equipo de Compras & Ventas, asegurando el funcionamiento y dinamismo de la Iglesia. Dirige el Ministerio Women Teens, enfocada en formar una Nueva generación de Mujeres firmes, con identidad, propósito y pasión por Cristo. También se desarrolla en el orden social, cultural y sexual de la congregación, presentando una Iglesia no mancillada, deleitando al Rey como una novia macrosanta. Prepara a los jóvenes y los capacita para su desarrollo universitario. Además, es Fundadora de la Microempresa FDV.' }
              ].map((pastora, index) => (
